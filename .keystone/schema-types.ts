...
export type ProblemImageRelateToOneInput = {
  readonly create?: ProblemImageCreateInput | null;
  readonly connect?: ProblemImageWhereUniqueInput | null;
  readonly disconnect?: ProblemImageWhereUniqueInput | null;
  readonly disconnectAll?: Scalars['Boolean'] | null;
};

export type ProblemWhereInput = {
  readonly AND?: ReadonlyArray<ProblemWhereInput | null> | null;
  readonly OR?: ReadonlyArray<ProblemWhereInput | null> | null;
  readonly id?: Scalars['ID'] | null;
  readonly id_not?: Scalars['ID'] | null;
  readonly id_in?: ReadonlyArray<Scalars['ID'] | null> | null;
  readonly id_not_in?: ReadonlyArray<Scalars['ID'] | null> | null;
  ...
  readonly description_in?: ReadonlyArray<Scalars['String'] | null> | null;
  readonly description_not_in?: ReadonlyArray<Scalars['String'] | null> | null;
  readonly photo?: ProblemImageWhereInput | null;
  readonly photo_is_null?: Scalars['Boolean'] | null;
  readonly status?: Scalars['String'] | null;
  readonly status_not?: Scalars['String'] | null;
  readonly status_contains?: Scalars['String'] | null;
...
export type ProblemUpdateInput = {
  readonly name?: Scalars['String'] | null;
  readonly description?: Scalars['String'] | null;
  readonly photo?: ProblemImageRelateToOneInput | null;
  readonly status?: Scalars['String'] | null;
};

export type ProblemsUpdateInput = {
  readonly id: Scalars['ID'];
  readonly data?: ProblemUpdateInput | null;
};
...
export type ProblemsCreateInput = {
  readonly data?: ProblemCreateInput | null;
};

export type ProblemRelateToOneInput = {
  readonly create?: ProblemCreateInput | null;
  readonly connect?: ProblemWhereUniqueInput | null;
  readonly disconnect?: ProblemWhereUniqueInput | null;
  readonly disconnectAll?: Scalars['Boolean'] | null;
};

export type ProblemImageWhereInput = {
  readonly AND?: ReadonlyArray<ProblemImageWhereInput | null> | null;
  readonly OR?: ReadonlyArray<ProblemImageWhereInput | null> | null;
  readonly id?: Scalars['ID'] | null;
  readonly id_not?: Scalars['ID'] | null;
  readonly id_in?: ReadonlyArray<Scalars['ID'] | null> | null;
  readonly id_not_in?: ReadonlyArray<Scalars['ID'] | null> | null;
  ...
  readonly altText_in?: ReadonlyArray<Scalars['String'] | null> | null;
  readonly altText_not_in?: ReadonlyArray<Scalars['String'] | null> | null;
  readonly product?: ProblemWhereInput | null;
  readonly product_is_null?: Scalars['Boolean'] | null;
};

export type ProblemImageWhereUniqueInput = {
  readonly id: Scalars['ID'];
};

export type SortProblemImagesBy =
  | 'id_ASC'
  | 'id_DESC'
  | 'altText_ASC'
  | 'altText_DESC'
...
export type ProblemImageUpdateInput = {
  readonly image?: any | null;
  readonly altText?: Scalars['String'] | null;
  readonly product?: ProblemRelateToOneInput | null;
};

export type ProblemImagesUpdateInput = {
  readonly id: Scalars['ID'];
  readonly data?: ProblemImageUpdateInput | null;
};
...
export type ProblemImagesCreateInput = {
  readonly data?: ProblemImageCreateInput | null;
};
...
export type ProblemListTypeInfo = {
  key: 'Problem';
  fields: 'id' | 'name' | 'description' | 'photo' | 'status';
  backing: {
    readonly id: string;
  ...
  args: {
    listQuery: {
      readonly where?: ProblemWhereInput | null;
      readonly sortBy?: ReadonlyArray<SortProblemsBy> | null;
      readonly first?: Scalars['Int'] | null;
      readonly skip?: Scalars['Int'] | null;
    };
  };
...
export type ProblemListFn = (
  listConfig: import('@keystone-next/keystone/schema').ListConfig<
    ProblemListTypeInfo,
    ProblemListTypeInfo['fields']
  >
) => import('@keystone-next/keystone/schema').ListConfig<
  ProblemListTypeInfo,
  ProblemListTypeInfo['fields']
...
export type ProblemImageListTypeInfo = {
  key: 'ProblemImage';
  fields: 'id' | 'image' | 'altText' | 'product';
  backing: {
    readonly id: string;
  ...
  inputs: {
    ...
    create: ProblemImageCreateInput;
    update: ProblemImageUpdateInput;
  };
  args: {
    listQuery: {
      readonly where?: ProblemImageWhereInput | null;
      readonly sortBy?: ReadonlyArray<SortProblemImagesBy> | null;
      readonly first?: Scalars['Int'] | null;
      readonly skip?: Scalars['Int'] | null;
    };
  };
...
export type ProblemImageListFn = (
  listConfig: import('@keystone-next/keystone/schema').ListConfig<
    ProblemImageListTypeInfo,
    ProblemImageListTypeInfo['fields']
  >
) => import('@keystone-next/keystone/schema').ListConfig<
  ProblemImageListTypeInfo,
  ProblemImageListTypeInfo['fields']
...
export type KeystoneListsTypeInfo = {
  ...
  readonly Problem: ProblemListTypeInfo;
  readonly ProblemImage: ProblemImageListTypeInfo;
};
